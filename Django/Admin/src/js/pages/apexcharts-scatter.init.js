...
var chartBarColors = getChartColorsArray("basic_scatter");
var options = {
  series: [{
  name: "SAMPLE A",
  data: [
...
var chartBarColors = getChartColorsArray("datetime_scatter");
...
var chartBarColors = getChartColorsArray("images_scatter");
var options = {
  series: [{
  name: 'User A',
  data: [
...
fill: {
  ...
  opacity: 1,
  image: {
    src: ['/static/images/users/avatar-3.jpg', '/static/images/users/avatar-4.jpg'],
    width: 40,
    height: 40
  }
},
