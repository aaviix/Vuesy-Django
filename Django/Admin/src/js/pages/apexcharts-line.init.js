...
//  Basic Line Charts
var chartBarColors = getChartColorsArray("line_chart_basic");
var options = {
  series: [{
    name: "Desktops",
...
// Zoomable Timeseries
var chartBarColors = getChartColorsArray("line_chart_zoomable");
var options = {
  series: [{
    name: 'XYZ MOTORS',
    data: [{
...
var chartBarColors = getChartColorsArray("line_chart_datalabel");
var options = {
  chart: {
    height: 380,
    type: 'line',
...
//  Dashed line chart
var chartBarColors = getChartColorsArray("line_chart_dashed");
var options = {
  chart: {
    height: 380,
    type: 'line',
...
var chartBarColors = getChartColorsArray("line_chart_annotations");
var options = {
  series: [{
...
// Syncing Charts
var chartBarColors = getChartColorsArray("syncingchart-line");
var options = {
  series: [{
...
var chart = new ApexCharts(document.querySelector("#syncingchart-line"), options);
chart.render();


var chartBarColors = getChartColorsArray("syncingchart-area");
var optionsArea = {
  series: [{
    data: generateDayWiseTimeSeries(new Date('11 Feb 2017').getTime(), 20, {
      min: 10,
...
var chartArea = new ApexCharts(document.querySelector("#syncingchart-area"), optionsArea);
chartArea.render();
...
// Brush Chart
var chartBarColors = getChartColorsArray("brushchart_line2");
var options = {
  series: [{
    data: data
  }],
...
var chartBarColors = getChartColorsArray("brushchart_line");
var optionsLine = {
  series: [{
    data: data
  }],
...
// Stepline Charts
var chartBarColors = getChartColorsArray("line_chart_stepline");
var options = {
  series: [{
...
//   Gradient Line
var chartBarColors = getChartColorsArray("line_chart_gradient");
var options = {
  series: [{
    name: 'Likes',
...
//   Missing Data
var chartBarColors = getChartColorsArray("line_chart_missing_data");
var options = {
  series: [{
    name: 'Peter',
...
// Realtime Charts
var chartBarColors = getChartColorsArray("line_chart_realtime");
var options = {
  series: [{
    data: data.slice()
  }],
