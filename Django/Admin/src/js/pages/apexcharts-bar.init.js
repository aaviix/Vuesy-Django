...
var chartBarColors = getChartColorsArray("custom_datalabels_bar");
var options = {
  series: [{
...
// Stacked Bar Charts
var chartBarColors = getChartColorsArray("stacked_bar");
var options = {
  series: [{
    name: 'Marine Sprite',
...
// Stacked Bars 100
var chartBarColors = getChartColorsArray("stacked_bar_100");
var options = {
  series: [{
    name: 'Marine Sprite',
    data: [44, 55, 41, 37, 22, 43, 21]
...
var chartBarColors = getChartColorsArray("negative_bars");
var options = {
  series: [{
    name: 'Males',
...
//   Bar with Markers
var chartBarColors = getChartColorsArray("bar_markers");
var options = {
  series: [
    {
      name: 'Actual',
...
// Reversed Bar Chart
var chartBarColors = getChartColorsArray("reversed_bars");
var options = {
  series: [{
...
// Patterned Charts
var chartBarColors = getChartColorsArray("patterned_bars");
var options = {
  series: [{
    name: 'Marine Sprite',
    data: [44, 55, 41, 37, 22, 43, 21]
...
// Groupes Bar Charts
var chartBarColors = getChartColorsArray("grouped_bar");
var options = {
  series: [{
...
// Bar with Images
var chartBarColors = getChartColorsArray("bar_images");
var options = {
  series: [{
    name: 'coins',
  ...
  fill: {
    ...
    opacity: 0.87,
    image: {
      src: ['/static/images/pattern-bg.jpg'],
      width: 466,
      height: 406
    }
  },
